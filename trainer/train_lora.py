...
if __name__ == "__main__":
    ...
    parser.add_argument("--lora_name", type=str, default="lora_graduate", help="LoRA权重名称(如lora_identity/lora_medical等)")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/graduate_handbook_sft.jsonl", help="LoRA训练数据路径")
    parser.add_argument('--from_weight', default='pretrain', type=str, help="基于哪个权重训练，默认full_sft")
